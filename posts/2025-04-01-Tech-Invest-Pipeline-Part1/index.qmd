...
g1<-ggplot(py$df,aes(x=as_date(date)))+
    ...
    geom_line(aes(y=signal),color="#00A9FF",linewidth=1.1)+
    geom_line(aes(y=MACD),color="#00BE67",linewidth=1.1)+
    scale_x_date(
        limits=c(l,u),
        date_breaks="1 week",
        date_minor_breaks="1 day",
...
g3<-ggplot(py$df,aes(x=as_date(date)))+
    ...
    geom_line(aes(y=RSI),linewidth=1.1,color="#00BE67")+
    scale_x_date(
        limits=c(l,u),
        date_breaks="1 week",
        date_minor_breaks="1 day",
...
p<-ggplot(py$df,aes(x=as_date(date)))+
    geom_line(aes(y=sma_l),color="#00A9FF",linewidth=1.1)+
    geom_line(aes(y=sma_s),color="#00BE67",linewidth=1.1)+
