...
This isn't perfect, and I think I will probably end up labelling places directly without the garbage raster labels from a base map, but I think it's promising. Still lots to work out, but that's the fun part, right?